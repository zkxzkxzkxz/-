...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/crm/crmCustomAssign/">客户资料列表</a></li>
		<li class="active"><a href="${ctx}/crm/crmCustomAssign/form?id=${crmCustom.id}">客户资料<shiro:hasPermission name="crm:crmCustomAssign:edit">${not empty crmCustom.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="crm:crmCustomAssign:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="crmCustom" action="${ctx}/crm/crmCustomAssign/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="crm:crmCustomAssign:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
